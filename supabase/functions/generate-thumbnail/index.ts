...
serve(async (req) => {
  ...
  try {
    ...
    const styleDescriptions: Record<string, string> = {
      vibrant: "vibrant bold colors, high contrast, eye-catching, dynamic lighting, saturated",
      minimal: "clean minimalist, simple composition, elegant, subtle colors, modern",
      dramatic: "dark moody, intense, cinematic lighting, dramatic shadows, epic",
      playful: "fun colorful, energetic, playful elements, bright cheerful, cartoon style",
    };

    const styleDesc = styleDescriptions[style] || styleDescriptions.vibrant;

    const prompt = `Create a YouTube video thumbnail image for: "${topic}". 
...
- Dramatic composition that draws attention
